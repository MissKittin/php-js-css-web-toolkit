...
<html<?php if(isset($this->registry['_lang'])) echo ' lang="'.$this->registry['_lang'].'"'; ?>>
	...
	<body class="sbc_grey sbbc_black">
		<div id="header" class="sb_header sbc_black sbbc_green_900">
			<h1><?php echo $this->registry['_panel_label']; ?></h1>
			<div id="logout_button">
				<?php if(isset($this->registry['_show_logout_button'])) { ?>
					<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
						<input type="submit" name="<?php echo $this->registry['_logout_button_name']; ?>" value="<?php echo $this->registry['_logout_button_label']; ?>" class="button sb_button sbc_grey_300 sbbc_green_800">
						<input type="hidden" name="<?php echo $this->registry['_csrf_token']['name']; ?>" value="<?php echo $this->registry['_csrf_token']['value']; ?>">
					</form>
				<?php } ?>
			</div>
		</div>
		<div id="headlinks" class="sb_headlinks sbbc_black">
		...
		<?php if(isset($_module['template_header'])) { ?>
			<div id="content_header" class="sb_content_header sbc_grey sbbc_grey_900"><h3><?php echo $_module['template_header']; ?></h3></div>
		<?php } ?>
		<div id="content" class="sb_content sbbc_grey_900">
			<?php
				if(
					isset($_module['class']) &&
