...
function checkDate(startDay, startMonth, endDay, endMonth)
{
	...
	var calculateBetweenYears=function(startMonth, currentDate, currentYear, endMonth, endDay, startDay)
	{
	...
	if(startMonth <= endMonth)
	{
		if((startMonth === endMonth) && (startDay > endDay))
			return calculateBetweenYears(startMonth, currentDate, currentYear, endMonth, endDay, startDay);
