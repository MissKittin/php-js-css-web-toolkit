...
function clockDigitalImage(id, pics, separator)
{
	...
	setTimeout(
		'clockDigitalImage("'+id+'", '+JSON.stringify(pics)+', "'+separator+'")',
		1000
	);
}
function clockDigitalImageSprite(id, spritePic, clockHeight, digitWidth, separatorWidth, picsOffsets, separatorOffset, setup=true)
{
	...
	setTimeout(
		'clockDigitalImageSprite("'+id+'", "'+spritePic+'", "'+clockHeight+'", "'+digitWidth+'", "'+separatorWidth+'", '+JSON.stringify(picsOffsets)+', "'+separatorOffset+'", false)',
		1000
	);
}
function clockAnalogCSS(id, color, animate=true, setup=true, loops=[0, 0, 0])
{
	...
	if(dateSeconds%360 === 0)
		loops[0]++;

	if(dateMinutes%360 === 0)
		loops[1]++;
	...
	setTimeout(
		'clockAnalogCSS("'+id+'", "'+color+'", false, false, '+JSON.stringify(loops)+')',
		1000
	);
}
function clockAnalogImage(id, pics, animate=true, setup=true, loops=[0, 0, 0])
{
	...
	setTimeout(
		'clockAnalogImage("'+id+'", false, false, false, '+JSON.stringify(loops)+')',
		1000
	);
}
function clockAnalogImageSprite(id, spritePic, picsOffsets, animate=true, setup=true, loops=[0, 0, 0])
{
	...
	setTimeout(
		'clockAnalogImageSprite("'+id+'", "'+spritePic+'", '+JSON.stringify(picsOffsets)+', false, false, '+JSON.stringify(loops)+')',
		1000
	);
}