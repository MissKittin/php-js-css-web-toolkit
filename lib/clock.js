...
function clockAnalogCSS(id, color, setup=true, loops=[0, 0, 0])
{
	/*
	...
	if(setup)
	{
		...
		/*
		clockContainerContent+=' \
			<div id="clockAnalogCSS_hour" style="transform: rotate('+dateHours+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"> \
				<div style="position: absolute; top: 20%; left: 48.5%; width: 3.5%; height: 30%; background-color: '+color+';"></div> \
			</div> \
			<div id="clockAnalogCSS_minute" style="transform: rotate('+dateMinutes+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"> \
				<div style="position: absolute; top: 8%; left: 49%; width: 2%; height: 49.5%; background-color: '+color+';"></div> \
			</div> \
			<div id="clockAnalogCSS_second" style="transform: rotate('+dateSeconds+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"> \
		...
		*/
		clockContainerContent+=' \
			<div style="transform: rotate('+dateHours+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"> \
				<div style="position: absolute; top: 20%; left: 48.5%; width: 3.5%; height: 30%; background-color: '+color+';"></div> \
			</div> \
			<div style="transform: rotate('+dateMinutes+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"> \
				<div style="position: absolute; top: 8%; left: 49%; width: 2%; height: 49.5%; background-color: '+color+';"></div> \
			</div> \
			<div style="transform: rotate('+dateSeconds+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"> \
				<div style="position: absolute; top: 5%; left: 49.5%; width: 1%; height: 55%; background-color: '+color+';"></div> \
			</div> \
			<div style="position: absolute; top: 44.75%; left: 44.75%; border-radius: 50%; width: 10.5%; height: 10.5%; background-color: '+color+';"></div> \
		';
	...
	clockRoot.querySelector('#clockAnalogCSS_second').style.transform='rotate('+dateSeconds+'deg)';
	clockRoot.querySelector('#clockAnalogCSS_minute').style.transform='rotate('+dateMinutes+'deg)';
	clockRoot.querySelector('#clockAnalogCSS_hour').style.transform='rotate('+dateHours+'deg)';
	*/
	var clockRoot=clockContainer.children[0];
	...
	setTimeout('clockAnalogCSS("'+id+'", "'+color+'", false, '+JSON.stringify(loops)+')', 1000);
}
function clockAnalogImage(id, pics, setup=true, loops=[0, 0, 0])
{
	/*
	...
	if(setup)
	{
		...
		clockContainer.innerHTML=' \
			<div style="background-image: url('+pics[0]+'); background-repeat: no-repeat; position: absolute; width: 100%; height: 100%;"> \
				<div id="clockAnalogImage_hour" style="background-image: url('+pics[1]+'); background-repeat: no-repeat; transform: rotate('+dateHours+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"></div> \
				<div id="clockAnalogImage_minute" style="background-image: url('+pics[2]+'); background-repeat: no-repeat; transform: rotate('+dateMinutes+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"></div> \
				<div id="clockAnalogImage_second" style="background-image: url('+pics[3]+'); background-repeat: no-repeat; transform: rotate('+dateSeconds+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"></div> \
		...
		*/
		clockContainer.innerHTML=' \
			<div style="background-image: url('+pics[0]+'); background-repeat: no-repeat; position: absolute; width: 100%; height: 100%;"> \
				<div style="background-image: url('+pics[1]+'); background-repeat: no-repeat; transform: rotate('+dateHours+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"></div> \
				<div style="background-image: url('+pics[2]+'); background-repeat: no-repeat; transform: rotate('+dateMinutes+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"></div> \
				<div style="background-image: url('+pics[3]+'); background-repeat: no-repeat; transform: rotate('+dateSeconds+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; width: 100%; height: 100%;"></div> \
				<div style="background-image: url('+pics[4]+'); background-repeat: no-repeat; position: absolute; width: 100%; height: 100%;"></div> \
			</div> \
		';
	}
	...
	/*
	var clockRoot=clockContainer.children[0];
	clockRoot.querySelector('#clockAnalogImage_second').style.transform='rotate('+dateSeconds+'deg)';
	clockRoot.querySelector('#clockAnalogImage_minute').style.transform='rotate('+dateMinutes+'deg)';
	clockRoot.querySelector('#clockAnalogImage_hour').style.transform='rotate('+dateHours+'deg)';
	*/
	var clockRoot=clockContainer.children[0];
	...
	setTimeout('clockAnalogImage("'+id+'", false, false, '+JSON.stringify(loops)+')', 1000);
}
function clockAnalogImageSprite(id, spritePic, picsOffsets, setup=true, loops=[0, 0, 0])
{
	/*
	...
	if(setup)
		clockContainer.innerHTML=' \
			<div style="position: relative; border-radius: 50%; width: 100%; height: 100%;"> \
				...
				<div style="transform: rotate('+dateHours+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; background-image: url('+spritePic+'); background-position-x: -'+picsOffsets[0]+'; width: 100%; height: 100%;"></div> \
				<div style="transform: rotate('+dateMinutes+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; background-image: url('+spritePic+'); background-position-x: -'+picsOffsets[1]+'; width: 100%; height: 100%;"></div> \
				<div style="transform: rotate('+dateSeconds+'deg); transition: transform 0.2s cubic-bezier(.4, 2.08, .55, .44); position: absolute; background-image: url('+spritePic+'); background-position-x: -'+picsOffsets[2]+'; width: 100%; height: 100%;"></div> \
	...
	setTimeout('clockAnalogImageSprite("'+id+'", "'+spritePic+'", '+JSON.stringify(picsOffsets)+', false, '+JSON.stringify(loops)+')', 1000);
}