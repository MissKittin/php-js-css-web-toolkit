<?php
	...
	class uri_router
	{
		...
		public static function set_default_route($callback)
		{
			static::$default_route['callback']=$callback;
		}
		public static function set_reverse_mode($enable=false)
		{
			static::$reverse_mode=$enable;
		}

		public static function add($source, $callback, $use_regex=false, $request_method=null)
		{
