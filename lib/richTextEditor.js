function richTextEditor(RTEBox, sourceName, params={})
{
	...
	if(typeof params.buttonLabels === 'undefined')
		params.buttonLabels={
			'bold': 'Bold',
			'italic': 'Italic',
			'underline': 'Underline',
	...
	RTEBox.innerHTML=''
	+	 '<div>'
	+		'<input type="button" title="'+params.buttonLabels.bold+'" value="B">'
	+		'<input type="button" title="'+params.buttonLabels.italic+'" value="I">'
	+		'<input type="button" title="'+params.buttonLabels.underline+'" value="U">'
	+		'<input type="button" title="'+params.buttonLabels.left+'" value="L">'
	+		'<input type="button" title="'+params.buttonLabels.center+'" value="C">'
	+		'<input type="button" title="'+params.buttonLabels.right+'" value="R">'
	+		'<input type="button" title="'+params.buttonLabels.paragraph+'" value="P">'
	+		'<input type="button" title="'+params.buttonLabels.addLink+'" value="A">'
	+		'<input type="button" title="'+params.buttonLabels.removeLink+'" value="AX">'
	+		'<input type="button" title="'+params.buttonLabels.addImg+'" value="IMG">'
	+		'<input type="button" title="'+params.buttonLabels.addOl+'" value="OL">'
	+		'<input type="button" title="'+params.buttonLabels.addUl+'" value="UL">'
	+		'<input type="button" title="'+params.buttonLabels.src+'" value="SRC">'
	+	'</div>'
	+	'<div>'
	+		'<select title="'+params.buttonLabels.heading+'">'
	...
	+		'</select>'
	+		'<select title="'+params.buttonLabels.fontSize+'">'
	...
	+		'</select>'
	+		'<input type="button" title="'+params.buttonLabels.fColor+'" value="Fc">'
	+		'<input type="button" title="'+params.buttonLabels.bColor+'" value="Bc">'
	+		'<input type="button" value="">'
	+		'<input type="button" title="'+params.buttonLabels.removeFormat+'" value="X">'
	+	'</div>'
	+	'<hr>'
	+	'<div>'
	+		'<iframe></iframe>'
