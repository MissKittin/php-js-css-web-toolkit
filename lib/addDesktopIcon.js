 ...
 *
 * Usage:
 *  addDesktopIcon('desktop_div', './desktop-icon.png', '/desktop.html', 'Icon label', '#000')
 *  addDesktopSpriteIcon('desktop_div', './desktop-icons.png', '33px', '/desktop.html', 'Icon label', '#000')
 */
...
function addDesktopIcon(outputBox, iconImage, link, label, labelColor)
{
	...
	document.getElementById(outputBox).innerHTML+=outputContent+'</div>';
}
